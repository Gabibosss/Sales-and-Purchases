...
Public Class Form7
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        Try
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "select * from Table2 where id=" & i & ""
            cmd.ExecuteNonQuery()
            Dim dt As New DataTable()
            Dim da As New SqlDataAdapter(cmd)
            da.Fill(dt)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        cmd = con.CreateCommand()
        cmd.CommandType = CommandType.Text
        cmd.CommandText = "update Table2 set Product_Name='" + TextBox1.Text + "', Product_ID='" + TextBox2.Text + "', Quantity='" + TextBox3.Text + "', Price='" + TextBox4.Text + "' where id=" & i & ""
        cmd.ExecuteNonQuery()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            cmd = con.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "delete from Table2 where Product_Name='" + TextBox1.Text + "'"
            cmd.ExecuteNonQuery()
            Disp_data()
        Catch ex As Exception
            MessageBox.Show("Error", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Error)
